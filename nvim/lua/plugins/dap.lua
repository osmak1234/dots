return {
...

  {
    ...
    keys = {
      ...
      {
        "<leader>dbr",
        function() require("dap.breakpoints").clear() end,
        desc =
        "Remove All"
      },
      {
      ...
      {
        "<leader>dva",
        function() require("dap.ui.widgets").hover(nil, { border = "none" }) end,
        desc =
      ...
      {
        "<leader>dvs",
        function() require("dap.ui.widgets").sidebar(require("dap.ui.widgets").scopes, { border = "none" }) end,
        desc = "Show Scopes"
      },
      {
        "<leader>dvt",
